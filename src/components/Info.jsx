...
const Info = () => {
    return (
        <div>
            <img src="../src/assets/profile.png" alt="profile picture" width="317px" height="317px" className="profile"/>
            <div className="container">
                ...
                <img src="../src/assets/email.png" alt="email" width="17px" height="17px" className="email"/>Email
                </button>
                </a>
            </div>
        </div>
